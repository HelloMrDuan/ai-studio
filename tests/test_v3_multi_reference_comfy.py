...
class MultiReferenceComfyTests(unittest.TestCase):
    def test_faceid_profile_is_role_aware_and_supports_five_references(self) -> None:
        profile = json.loads(
    ...
    def test_role_aware_compiler_consumes_two_characters_location_and_two_props(self) -> None:
        ...
        refs = (
            ...
            ReferenceAsset("ref-prop-a", Path("prop-a.png"), "sha-pa", "image/png", "prop-a", "prop_reference", "prop"),
            ReferenceAsset("ref-prop-b", Path("prop-b.png"), "sha-pb", "image/png", "prop-b", "prop_reference", "prop"),
        )
        names = (
            "xiaoduan/a.png",
            "xiaoduan/b.png",
